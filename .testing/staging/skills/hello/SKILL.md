...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a0f1a-7046-7501-8f08-d60b724500ed`).

Command form:

```bash
betterprompt generate 019a0f1a-7046-7501-8f08-d60b724500ed \
  [--input <key>=<value>] \
  [--model <model>] \
