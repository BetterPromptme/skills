...
description: Generate a cinematic, ultra-detailed portrait that transforms a photographed person into an epic, surreal cosmic figure within a dramatic symbolic scene while preserving their recognizable facial identity and realistic proportions.
skillVersionId: 019c2805-4eaa-7049-a47e-ca9359c8616b
---

## What it does

This prompt instructs an image model to generate a cinematic, ultra-detailed space-fantasy scene of a colossal cosmic chessboard at the moment of checkmate, featuring a radiant cracked king and exploding pieces that morph into constellations amid nebula clouds and dramatic lighting. It requires transforming the person from the provided selfie into a hooded, galaxy-forged reaper-like entity while strictly preserving their recognizable facial identity with realistic proportions and avoiding common artifacts (extra fingers, distortions, duplicate faces). The intended result is a wide-angle, high-dynamic-range digital artwork in a dark blue and gold palette that blends surreal cosmic materials with grounded facial realism.
