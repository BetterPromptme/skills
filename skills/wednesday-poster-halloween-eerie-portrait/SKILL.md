...
Use the frontmatter's `name` as the positional argument (for this skill, use `wednesday-poster-halloween-eerie-portrait`).

Command form:

```bash
betterprompt generate wednesday-poster-halloween-eerie-portrait \
  [--image-input-url <url>] \
