---
name: sunlit-city-balcony-portrait
description: This prompt instructs an image-generation system to produce an ultra-photorealistic, luxury editorial-style vertical portrait of a serene young woman kneeling on a sunset shoreline with large, realistic angel wings, specifying precise pose, expression, styling, environment, lighting, color palette, camera aesthetics, and depth of field to achieve a cinematic fashion-magazine result while explicitly excluding common visual artifacts and unwanted elements.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `sunlit-city-balcony-portrait`).

Command form:

```bash
betterprompt generate sunlit-city-balcony-portrait \
  [--image-input-url <url>] \
