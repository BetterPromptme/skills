...
Use the frontmatter's `name` as the positional argument (for this skill, use `girl-at-milan-cathedral`).

Command form:

```bash
betterprompt generate girl-at-milan-cathedral \
  [--image-input-url <url>] \
