---
name: iridescent-cowboy-hat-playful-portrait
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `iridescent-cowboy-hat-playful-portrait`).

Command form:

```bash
betterprompt generate iridescent-cowboy-hat-playful-portrait \
  [--image-input-url <url>] \
