...
skillVersionId: 019b92dd-4ffa-761c-b075-931a20718fd4
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019b92dd-4ffa-761c-b075-931a20718fd4`).

Command form:

```bash
betterprompt generate 019b92dd-4ffa-761c-b075-931a20718fd4 \
  [--image-input-url <url>] \
