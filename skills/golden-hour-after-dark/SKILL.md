---
name: golden-hour-after-dark
description: This prompt instructs an AI to generate a high-resolution, photorealistic, vertically framed nighttime beach portrait with an editorial, cinematic look, using direct on-camera flash to sharply separate a realistically textured subject from a dark ocean-and-clouds background. It specifies strict identity preservation and natural proportions, along with detailed guidance for pose, expression, hair movement, makeup, outfit, accessories, lighting contrast, color palette, and background placement, resulting in a crisp, flash-lit upper-body image with moody atmospheric surroundings and minimal extraneous elements.
...
This prompt instructs an AI to generate a high-resolution, photorealistic, vertically framed nighttime beach portrait with an editorial, cinematic look, using direct on-camera flash to sharply separate a realistically textured subject from a dark ocean-and-clouds background. It specifies strict identity preservation and natural proportions, along with detailed guidance for pose, expression, hair movement, makeup, outfit, accessories, lighting contrast, color palette, and background placement, resulting in a crisp, flash-lit upper-body image with moody atmospheric surroundings and minimal extraneous elements.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `golden-hour-after-dark`).

Command form:

```bash
betterprompt generate golden-hour-after-dark \
  [--image-input-url <url>] \
