...
Use the frontmatter's `name` as the positional argument (for this skill, use `professional-linkedin-headshot`).

Command form:

```bash
betterprompt generate professional-linkedin-headshot \
  [--image-input-url <url>] \
