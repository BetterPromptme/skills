...
Use the frontmatter's `name` as the positional argument (for this skill, use `galactic-geometric-tide-visualizer`).

Command form:

```bash
betterprompt generate galactic-geometric-tide-visualizer \
  [--input <key>=<value>] \
  [--model <model>] \
