...
skillVersionId: 01983046-f469-767e-9d7d-19ee4c34166b
---

## What it does

This prompt directs the AI to generate a stylized visual depiction of a chosen subject within an abstract “Galactic Geometric Tide” theme, combining flowing, wave-like arcs with crisp triangular geometry. The result is a cosmic-yet-liquid composition rendered in luminous gradients of two specified colors, creating an image that blends solid structure with fluid motion.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `01983046-f469-767e-9d7d-19ee4c34166b`).

Command form:

```bash
betterprompt generate 01983046-f469-767e-9d7d-19ee4c34166b \
  [--input <key>=<value>] \
  [--model <model>] \
