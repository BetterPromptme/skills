...
skillVersionId: 01991833-19bd-732c-87bc-05bcc9d349d7
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `01991833-19bd-732c-87bc-05bcc9d349d7`).

Command form:

```bash
betterprompt generate 01991833-19bd-732c-87bc-05bcc9d349d7 \
  [--input <key>=<value>] \
  [--model <model>] \
