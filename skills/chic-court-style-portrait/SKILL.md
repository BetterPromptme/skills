---
name: chic-court-style-portrait
description: This prompt directs an image-generation or editing model to produce a high-end, vertical outdoor tennis lifestyle portrait with a specific pose, expression, outfit, and pastel paddle on a public court, using bright natural midday lighting and commercial editorial styling. It tightly constrains facial and body identity preservation while specifying composition, environment details, color palette, textures, and realism, and it includes exclusions to avoid action shots, heavy retouching, distortion, or low-quality artifacts. The result is a crisp, luxury sportswear campaign–style image that feels athletic, elegant, and social-media ready.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `chic-court-style-portrait`).

Command form:

```bash
betterprompt generate chic-court-style-portrait \
  [--image-input-url <url>] \
