...
skillVersionId: 01979aba-6f88-7f34-998c-30d0931c2987
---
...
| --- | ---: | --- | --- |
| `LANDMARK` | Required |  | (none) |
| `FURNITURE` | Required |  | (none) |
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `01979aba-6f88-7f34-998c-30d0931c2987`).

Command form:

```bash
betterprompt generate 01979aba-6f88-7f34-998c-30d0931c2987 \
  [--input <key>=<value>] \
  [--model <model>] \
