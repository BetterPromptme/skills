...
skillVersionId: 0197ee71-a292-7399-837a-9dc69943c624
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0197ee71-a292-7399-837a-9dc69943c624`).

Command form:

```bash
betterprompt generate 0197ee71-a292-7399-837a-9dc69943c624 \
  [--input <key>=<value>] \
  [--model <model>] \
