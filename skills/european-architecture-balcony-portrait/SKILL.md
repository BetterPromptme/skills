---
name: european-architecture-balcony-portrait
description: This prompt directs an AI image generator to create a high-end fashion editorial photograph set in a monumental historic European shopping gallery, specifying the balcony vantage point, subject pose and styling, architectural features, lighting, color palette, and technical finish. The intended outcome is a vertically framed, cinematic, luxury-campaign image where a poised, elegantly dressed woman is integrated into the grand neoclassical atrium scene, with precise textures and scale, while excluding modern, casual, low-quality, or distorted visual elements.
...
This prompt directs an AI image generator to create a high-end fashion editorial photograph set in a monumental historic European shopping gallery, specifying the balcony vantage point, subject pose and styling, architectural features, lighting, color palette, and technical finish. The intended outcome is a vertically framed, cinematic, luxury-campaign image where a poised, elegantly dressed woman is integrated into the grand neoclassical atrium scene, with precise textures and scale, while excluding modern, casual, low-quality, or distorted visual elements.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `european-architecture-balcony-portrait`).

Command form:

```bash
betterprompt generate european-architecture-balcony-portrait \
  [--image-input-url <url>] \
