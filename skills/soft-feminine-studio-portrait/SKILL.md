...
skillVersionId: 019c2d34-99c1-771c-a8dd-d835d56a6bcf
---

## What it does

This prompt instructs the AI to take an uploaded selfie or portrait and convert it into a realistic, minimalist studio-style lifestyle image with a soft, warm, feminine mood, using gentle diffused lighting, a clean light background, and a relaxed mid-shot pose in floral styling. The intended outcome is an airy, editorial-looking portrait that preserves natural facial proportions and skin texture while avoiding heavy retouching, distortions, stylized effects, text, or other unwanted artifacts.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019c2d34-99c1-771c-a8dd-d835d56a6bcf`).

Command form:

```bash
betterprompt generate 019c2d34-99c1-771c-a8dd-d835d56a6bcf \
  [--image-input-url <url>] \
