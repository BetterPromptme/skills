...
Use the frontmatter's `name` as the positional argument (for this skill, use `soft-feminine-studio-portrait`).

Command form:

```bash
betterprompt generate soft-feminine-studio-portrait \
  [--image-input-url <url>] \
