...
skillVersionId: 0196e755-4834-78c3-b1c7-22265e3b62e6
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0196e755-4834-78c3-b1c7-22265e3b62e6`).

Command form:

```bash
betterprompt generate 0196e755-4834-78c3-b1c7-22265e3b62e6 \
  [--input <key>=<value>] \
  [--model <model>] \
