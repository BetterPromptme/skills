...
skillVersionId: 019a80b5-ba4b-7236-a1a6-7730a1928ad1
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a80b5-ba4b-7236-a1a6-7730a1928ad1`).

Command form:

```bash
betterprompt generate 019a80b5-ba4b-7236-a1a6-7730a1928ad1 \
  [--image-input-url <url>] \
