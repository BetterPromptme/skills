...
Use the frontmatter's `name` as the positional argument (for this skill, use `concert-joy-three-panel-portrait`).

Command form:

```bash
betterprompt generate concert-joy-three-panel-portrait \
  [--image-input-url <url>] \
