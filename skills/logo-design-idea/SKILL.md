...
skillVersionId: 0196e753-b917-71a0-b937-1ff82c01f7ea
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0196e753-b917-71a0-b937-1ff82c01f7ea`).

Command form:

```bash
betterprompt generate 0196e753-b917-71a0-b937-1ff82c01f7ea \
  [--input <key>=<value>] \
  [--model <model>] \
