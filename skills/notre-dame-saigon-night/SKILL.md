---
name: notre-dame-saigon-night
description: This prompt instructs an image-editing model to take the user’s provided portrait photo and composite it into a new photorealistic nighttime scene that matches the referenced Notre-Dame Cathedral (Ho Chi Minh City) location for background, lighting, and atmosphere, while keeping the user’s facial identity exactly unchanged. The expected result is a realistic night portrait of the same person standing on a balcony with a black-painted railing in a specified side-profile pose, featuring warm golden illumination, accurate shadows/reflections, and correct perspective consistent with the reference environment.
skillVersionId: 019b0b36-0e08-70fb-9f94-6d8e617d57dc
---

## What it does

This prompt instructs an image-editing model to take the user’s provided portrait photo and composite it into a new photorealistic nighttime scene that matches the referenced Notre-Dame Cathedral (Ho Chi Minh City) location for background, lighting, and atmosphere, while keeping the user’s facial identity exactly unchanged. The expected result is a realistic night portrait of the same person standing on a balcony with a black-painted railing in a specified side-profile pose, featuring warm golden illumination, accurate shadows/reflections, and correct perspective consistent with the reference environment.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019b0b36-0e08-70fb-9f94-6d8e617d57dc`).

Command form:

```bash
betterprompt generate 019b0b36-0e08-70fb-9f94-6d8e617d57dc \
  [--image-input-url <url>] \
