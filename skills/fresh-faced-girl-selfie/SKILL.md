...
Use the frontmatter's `name` as the positional argument (for this skill, use `fresh-faced-girl-selfie`).

Command form:

```bash
betterprompt generate fresh-faced-girl-selfie \
  [--image-input-url <url>] \
