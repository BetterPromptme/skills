...
Use the frontmatter's `name` as the positional argument (for this skill, use `golden-hour-transit`).

Command form:

```bash
betterprompt generate golden-hour-transit \
  [--image-input-url <url>] \
