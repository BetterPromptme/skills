...
skillVersionId: 019a7739-2661-7008-b69f-ea0df22d90b2
---

## What it does

This prompt instructs an AI image generator to produce a high-definition, cinematic editorial fashion portrait set in a luxurious marble-and-gold bathroom, featuring a poised, vintage-inspired subject lit by warm ambient lamp light and framed with shallow depth of field and realistic reflections. The result is a timeless, intimate, photorealistic fashion image that emphasizes refined styling, accurate identity preservation, and detailed rendering of skin, fabric, and reflective surfaces.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a7739-2661-7008-b69f-ea0df22d90b2`).

Command form:

```bash
betterprompt generate 019a7739-2661-7008-b69f-ea0df22d90b2 \
  [--image-input-url <url>] \
