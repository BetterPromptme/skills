...
skillVersionId: 0197aa2b-9501-74d9-9ccc-98c2d04af9c4
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0197aa2b-9501-74d9-9ccc-98c2d04af9c4`).

Command form:

```bash
betterprompt generate 0197aa2b-9501-74d9-9ccc-98c2d04af9c4 \
  [--input <key>=<value>] \
  [--model <model>] \
