...
skillVersionId: 019830f9-9247-72b3-9b25-224be847047e
---

## What it does

This prompt directs an image generator to create a minimalist composition on a clean white background where vibrant, richly textured feathers are precisely and symmetrically arranged to form a phoenix silhouette. The result is a calm, softly lit, gentle, and elegant artwork emphasizing balanced layout and detailed feather surfaces with varied color.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019830f9-9247-72b3-9b25-224be847047e`).

Command form:

```bash
betterprompt generate 019830f9-9247-72b3-9b25-224be847047e \
  [--input <key>=<value>] \
  [--model <model>] \
