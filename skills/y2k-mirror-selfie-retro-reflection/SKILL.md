...
skillVersionId: 019a0b09-3e1c-73ea-b3cf-308365261b2d
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a0b09-3e1c-73ea-b3cf-308365261b2d`).

Command form:

```bash
betterprompt generate 019a0b09-3e1c-73ea-b3cf-308365261b2d \
  [--image-input-url <url>] \
