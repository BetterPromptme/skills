...
Use the frontmatter's `name` as the positional argument (for this skill, use `y2k-mirror-selfie-retro-reflection`).

Command form:

```bash
betterprompt generate y2k-mirror-selfie-retro-reflection \
  [--image-input-url <url>] \
