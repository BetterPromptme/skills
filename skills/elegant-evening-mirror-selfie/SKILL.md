---
name: elegant-evening-mirror-selfie
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `elegant-evening-mirror-selfie`).

Command form:

```bash
betterprompt generate elegant-evening-mirror-selfie \
  [--image-input-url <url>] \
