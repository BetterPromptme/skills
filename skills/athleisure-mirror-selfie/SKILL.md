---
name: athleisure-mirror-selfie
description: This prompt directs an image model to generate an ultra-realistic, full-body vertical mirror-selfie editorial photo of the same subject in a warm, minimalist luxury bathroom, specifying strict identity preservation, exact pose and styling, detailed environment elements, and soft-glam lighting/color grading so the result looks like a polished influencer-fashion bathroom portrait with believable textures and proportions.
...
This prompt directs an image model to generate an ultra-realistic, full-body vertical mirror-selfie editorial photo of the same subject in a warm, minimalist luxury bathroom, specifying strict identity preservation, exact pose and styling, detailed environment elements, and soft-glam lighting/color grading so the result looks like a polished influencer-fashion bathroom portrait with believable textures and proportions.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `athleisure-mirror-selfie`).

Command form:

```bash
betterprompt generate athleisure-mirror-selfie \
  [--image-input-url <url>] \
