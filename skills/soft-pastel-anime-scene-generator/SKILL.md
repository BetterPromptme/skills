...
skillVersionId: 0198981e-aaac-7b98-9558-54335ccdb7e3
---

## What it does

This prompt instructs an image model to generate a 2D animated-style illustration of a specified subject in a fluid, anime-inspired watercolor aesthetic, emphasizing soft linework, delicate motion cues, and a dreamy, weightless mood. It also guides the creation of a harmonious background using the provided setting and two chosen colors blended gently to add emotional depth and cohesive visual balance.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0198981e-aaac-7b98-9558-54335ccdb7e3`).

Command form:

```bash
betterprompt generate 0198981e-aaac-7b98-9558-54335ccdb7e3 \
  [--input <key>=<value>] \
  [--model <model>] \
