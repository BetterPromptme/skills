...
Use the frontmatter's `name` as the positional argument (for this skill, use `soft-pastel-anime-scene-generator`).

Command form:

```bash
betterprompt generate soft-pastel-anime-scene-generator \
  [--input <key>=<value>] \
  [--model <model>] \
