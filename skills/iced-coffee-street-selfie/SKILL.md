---
name: iced-coffee-street-selfie
description: This prompt instructs an image generation/editing model to produce a high-resolution, smartphone-style vertical selfie of the same person in a European summer café-travel setting, specifying exact framing, pose, expression, outfit, accessories, iced coffee details, lighting, and a textured stone-wall background with a particular green emergency sign, while enforcing strict identity preservation and realism through detailed constraints and negative exclusions to avoid retouching, distortions, or mismatched elements.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `iced-coffee-street-selfie`).

Command form:

```bash
betterprompt generate iced-coffee-street-selfie \
  [--image-input-url <url>] \
