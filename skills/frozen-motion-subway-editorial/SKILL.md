...
Use the frontmatter's `name` as the positional argument (for this skill, use `frozen-motion-subway-editorial`).

Command form:

```bash
betterprompt generate frozen-motion-subway-editorial \
  [--image-input-url <url>] \
