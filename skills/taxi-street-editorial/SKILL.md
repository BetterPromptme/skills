...
skillVersionId: 019ce195-1445-753e-85b3-e6f912a69ac0
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019ce195-1445-753e-85b3-e6f912a69ac0`).

Command form:

```bash
betterprompt generate 019ce195-1445-753e-85b3-e6f912a69ac0 \
  [--image-input-url <url>] \
