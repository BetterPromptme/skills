...
Use the frontmatter's `name` as the positional argument (for this skill, use `elevator-noir-absolute-face-lock`).

Command form:

```bash
betterprompt generate elevator-noir-absolute-face-lock \
  [--image-input-url <url>] \
