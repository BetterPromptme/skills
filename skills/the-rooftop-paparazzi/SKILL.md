...
skillVersionId: 019c234b-321d-759d-8f4f-bd82cbffafd5
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019c234b-321d-759d-8f4f-bd82cbffafd5`).

Command form:

```bash
betterprompt generate 019c234b-321d-759d-8f4f-bd82cbffafd5 \
  [--image-input-url <url>] \
