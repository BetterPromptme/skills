...
Use the frontmatter's `name` as the positional argument (for this skill, use `selfie-with-peonies`).

Command form:

```bash
betterprompt generate selfie-with-peonies \
  [--image-input-url <url>] \
