...
skillVersionId: 019ca9f4-1092-7504-886d-e7e62178e7a7
---
...
| ---: | ---: | --- | --- |
| 1 | Yes | Portrait | `--image-input-url <url>` or `--image-input-base64 <base64>` or `--image-input-path <absolute path to image>` |
...
- Required images:
  - **Exactly 1** images: image 1 (Portrait). Images must be provided in this order.
...
If the required images are missing, **ask the human for what's missing**. Do not assume or fabricate values. Tell the human: **"Please provide images in this order: image 1 (Portrait)"**.

### Step 2: Run via BetterPrompt CLI

Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019ca9f4-1092-7504-886d-e7e62178e7a7`).

Command form:

```bash
betterprompt generate 019ca9f4-1092-7504-886d-e7e62178e7a7 \
  [--image-input-url <url>] \
