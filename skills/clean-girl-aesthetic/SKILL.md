...
skillVersionId: 019cdcbb-bd71-734d-9876-7e2e78b08cf5
---

## What it does

This prompt instructs an AI image generator to produce a high-resolution, photorealistic vertical mirror-selfie portrait of a young woman seated in a softly lit, minimalist modern bedroom, specifying exact pose, outfit, accessories, background elements, color palette, and natural daylight lighting to achieve a calm, elegant lifestyle aesthetic while enforcing strict guardrails that preserve the subject’s facial identity, proportions, and realistic skin texture without beautification or reshaping.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019cdcbb-bd71-734d-9876-7e2e78b08cf5`).

Command form:

```bash
betterprompt generate 019cdcbb-bd71-734d-9876-7e2e78b08cf5 \
  [--image-input-url <url>] \
