---
name: streetwear-escalator-shot
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `streetwear-escalator-shot`).

Command form:

```bash
betterprompt generate streetwear-escalator-shot \
  [--image-input-url <url>] \
