...
Use the frontmatter's `name` as the positional argument (for this skill, use `ethereal-sunset-portrait`).

Command form:

```bash
betterprompt generate ethereal-sunset-portrait \
  [--image-input-url <url>] \
