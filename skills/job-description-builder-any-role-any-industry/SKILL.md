...
skillVersionId: 0198c544-89fe-7f6b-9a6d-4c60ff08dbf3
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0198c544-89fe-7f6b-9a6d-4c60ff08dbf3`).

Command form:

```bash
betterprompt generate 0198c544-89fe-7f6b-9a6d-4c60ff08dbf3 \
  [--input <key>=<value>] \
  [--model <model>] \
