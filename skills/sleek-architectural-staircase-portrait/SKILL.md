---
name: sleek-architectural-staircase-portrait
description: This prompt instructs an AI image generator to produce an ultra-photorealistic, magazine-quality fashion editorial portrait of a young woman posed full-body at the center of a perfectly symmetrical modern staircase in a luxury commercial interior, with detailed specifications for styling, facial features, accessories, lighting, reflections, composition, camera perspective, and color grading. The intended outcome is a high-end, architecturally precise campaign image with a premium editorial look, while explicitly avoiding common visual artifacts and compositional flaws through a defined negative constraint list.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `sleek-architectural-staircase-portrait`).

Command form:

```bash
betterprompt generate sleek-architectural-staircase-portrait \
  [--image-input-url <url>] \
