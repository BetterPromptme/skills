...
skillVersionId: 019b6868-1e4f-753f-9899-fbc11a065a9a
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019b6868-1e4f-753f-9899-fbc11a065a9a`).

Command form:

```bash
betterprompt generate 019b6868-1e4f-753f-9899-fbc11a065a9a \
  [--image-input-url <url>] \
