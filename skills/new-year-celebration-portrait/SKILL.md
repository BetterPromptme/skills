...
Use the frontmatter's `name` as the positional argument (for this skill, use `new-year-celebration-portrait`).

Command form:

```bash
betterprompt generate new-year-celebration-portrait \
  [--image-input-url <url>] \
