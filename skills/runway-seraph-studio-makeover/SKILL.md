...
Use the frontmatter's `name` as the positional argument (for this skill, use `runway-seraph-studio-makeover`).

Command form:

```bash
betterprompt generate runway-seraph-studio-makeover \
  [--image-input-url <url>] \
