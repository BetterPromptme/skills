...
Use the frontmatter's `name` as the positional argument (for this skill, use `whispering-light-photography`).

Command form:

```bash
betterprompt generate whispering-light-photography \
  [--image-input-url <url>] \
