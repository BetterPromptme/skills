...
skillVersionId: 0198bc97-26a7-7384-8368-8ab1bbedcbca
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0198bc97-26a7-7384-8368-8ab1bbedcbca`).

Command form:

```bash
betterprompt generate 0198bc97-26a7-7384-8368-8ab1bbedcbca \
  [--input <key>=<value>] \
  [--model <model>] \
