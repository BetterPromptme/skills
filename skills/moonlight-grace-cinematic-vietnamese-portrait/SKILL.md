...
| --- | ---: | --- | --- |
| `lighting_tone` | Optional | Defines the mood, temperature, and direction of the primary light source. Controls atmosphere, contrast, and realism of the portrait. | `cinematic moonlight` |
| `petal_intensity` | Optional | Determines the amount and motion density of floating red petals surrounding the subject. Controls how dynamic or tranquil the scene feels. | `few petals` |
...
- Optional text inputs (use defaults if not provided by the human):
    - `lighting_tone` (default: `cinematic moonlight`)
  - `petal_intensity` (default: `few petals`)
- Required images:
