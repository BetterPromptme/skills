...
Use the frontmatter's `name` as the positional argument (for this skill, use `rustic-western-portrait`).

Command form:

```bash
betterprompt generate rustic-western-portrait \
  [--image-input-url <url>] \
