...
Use the frontmatter's `name` as the positional argument (for this skill, use `paris-glass-railing-editorial`).

Command form:

```bash
betterprompt generate paris-glass-railing-editorial \
  [--image-input-url <url>] \
