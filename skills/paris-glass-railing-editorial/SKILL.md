...
skillVersionId: 019d0016-ac22-72ac-829d-1361b0af19aa
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019d0016-ac22-72ac-829d-1361b0af19aa`).

Command form:

```bash
betterprompt generate 019d0016-ac22-72ac-829d-1361b0af19aa \
  [--image-input-url <url>] \
