...
Use the frontmatter's `name` as the positional argument (for this skill, use `elevator-glow-portrait`).

Command form:

```bash
betterprompt generate elevator-glow-portrait \
  [--image-input-url <url>] \
