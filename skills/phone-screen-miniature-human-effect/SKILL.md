...
| ---: | ---: | --- | --- |
| 1 | Yes | Upload your phone photo | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | Upload your portrait photo (outfit and pose will be kept exactly in the output) | `--image-input-url <url>` or `--image-input-path <path>` |
