---
name: photo-booth-aesthetic
description: This prompt instructs an image model to generate a high-resolution, photorealistic photograph of a MacBook screen viewed at a slight angle, showing the macOS Photo Booth app capturing a candid mirror-selfie scene in a warm, cozy bedroom. It specifies precise UI details, subject styling and expression, layered screen-photography realism (glare, reflections, mild softness), and lighting/color mood, while enforcing strict rules to preserve the subject’s facial identity and natural texture. The expected outcome is an authentic-looking screen photo that balances crisp interface elements with believable camera-captured display artifacts and a modern digital-lifestyle aesthetic.
...
This prompt instructs an image model to generate a high-resolution, photorealistic photograph of a MacBook screen viewed at a slight angle, showing the macOS Photo Booth app capturing a candid mirror-selfie scene in a warm, cozy bedroom. It specifies precise UI details, subject styling and expression, layered screen-photography realism (glare, reflections, mild softness), and lighting/color mood, while enforcing strict rules to preserve the subject’s facial identity and natural texture. The expected outcome is an authentic-looking screen photo that balances crisp interface elements with believable camera-captured display artifacts and a modern digital-lifestyle aesthetic.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `photo-booth-aesthetic`).

Command form:

```bash
betterprompt generate photo-booth-aesthetic \
  [--image-input-url <url>] \
