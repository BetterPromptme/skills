...
Use the frontmatter's `name` as the positional argument (for this skill, use `top-interview-questions-for-all-fields`).

Command form:

```bash
betterprompt generate top-interview-questions-for-all-fields \
  [--input <key>=<value>] \
  [--model <model>] \
