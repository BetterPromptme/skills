...
| --- | ---: | --- | --- |
| `outfit` | Optional | Your clothing style and accessories | `ight blue and lavender color-block hoodie with Stitch print, paired with a denim mini skirt` |
| `pose_gesture` | Optional | The upper-body gesture or hand movement | `holding up a peace sign with the left hand` |
...
- Optional text inputs (use defaults if not provided by the human):
    - `outfit` (default: `ight blue and lavender color-block hoodie with Stitch print, paired with a denim mini skirt`)
  - `pose_gesture` (default: `holding up a peace sign with the left hand`)
- Required images:
