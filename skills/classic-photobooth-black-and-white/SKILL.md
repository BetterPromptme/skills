...
skillVersionId: 019bbb95-9fdc-70fa-af83-928f8e2258bc
---
...
| 2 | Yes | Upload your friend/lover photo | `--image-input-url <url>` or `--image-input-base64 <base64>` or `--image-input-path <absolute path to image>` |
...
- Required images:
  - **Exactly 2** images: image 1 (Upload your photo) and image 2 (Upload your friend/lover photo). Images must be provided in this order.
...
If the required images are missing, **ask the human for what's missing**. Do not assume or fabricate values. Tell the human: **"Please provide images in this order: image 1 (Upload your photo) and image 2 (Upload your friend/lover photo)"**.

### Step 2: Run via BetterPrompt CLI

Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019bbb95-9fdc-70fa-af83-928f8e2258bc`).

Command form:

```bash
betterprompt generate 019bbb95-9fdc-70fa-af83-928f8e2258bc \
  [--image-input-url <url>] \
