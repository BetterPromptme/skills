...
Use the frontmatter's `name` as the positional argument (for this skill, use `sultry-evening-portrait`).

Command form:

```bash
betterprompt generate sultry-evening-portrait \
  [--image-input-url <url>] \
