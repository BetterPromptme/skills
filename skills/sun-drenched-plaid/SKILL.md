...
Use the frontmatter's `name` as the positional argument (for this skill, use `sun-drenched-plaid`).

Command form:

```bash
betterprompt generate sun-drenched-plaid \
  [--image-input-url <url>] \
