...
Use the frontmatter's `name` as the positional argument (for this skill, use `high-flash-photography`).

Command form:

```bash
betterprompt generate high-flash-photography \
  [--image-input-url <url>] \
