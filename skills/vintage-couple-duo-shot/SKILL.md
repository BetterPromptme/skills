...
skillVersionId: 019a3412-47dc-7b98-948d-0f6d37afbf29
---
...
| 2 | Yes | Photo of your crush, lover or friend | `--image-input-url <url>` or `--image-input-base64 <base64>` or `--image-input-path <absolute path to image>` |
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a3412-47dc-7b98-948d-0f6d37afbf29`).

Command form:

```bash
betterprompt generate 019a3412-47dc-7b98-948d-0f6d37afbf29 \
  [--image-input-url <url>] \
