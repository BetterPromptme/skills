...
skillVersionId: 0197632d-0857-7812-8b41-8994bfa70fea
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0197632d-0857-7812-8b41-8994bfa70fea`).

Command form:

```bash
betterprompt generate 0197632d-0857-7812-8b41-8994bfa70fea \
  [--input <key>=<value>] \
  [--model <model>] \
