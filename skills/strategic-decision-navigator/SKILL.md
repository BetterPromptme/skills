...
skillVersionId: 0198df1e-9f2f-743a-8371-8f60f835a043
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0198df1e-9f2f-743a-8371-8f60f835a043`).

Command form:

```bash
betterprompt generate 0198df1e-9f2f-743a-8371-8f60f835a043 \
  [--input <key>=<value>] \
  [--model <model>] \
