...
Use the frontmatter's `name` as the positional argument (for this skill, use `office-cat-burnout-dual-version`).

Command form:

```bash
betterprompt generate office-cat-burnout-dual-version \
  [--image-input-url <url>] \
