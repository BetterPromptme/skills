...
skillVersionId: 01980713-4c86-72e4-a9a1-a593bb14f1ac
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `01980713-4c86-72e4-a9a1-a593bb14f1ac`).

Command form:

```bash
betterprompt generate 01980713-4c86-72e4-a9a1-a593bb14f1ac \
  [--input <key>=<value>] \
  [--model <model>] \
