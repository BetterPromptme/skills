...
| --- | ---: | --- | --- |
| `Upsell_type` | Required |  | (none) |
| `Target_Audience` | Required |  | (none) |
| `Core_Product_Name` | Required |  | (none) |
| `Number_of_upsell_ideas` | Required |  | (none) |
| `Core_Product_Description` | Required |  | (none) |
...
betterprompt generate upsell-idea-generator \
  ...
  --input Number_of_upsell_ideas=<value> \
  --input Core_Product_Description=<value> \
  --model gpt-4.1-mini \
  --options '{}'
```