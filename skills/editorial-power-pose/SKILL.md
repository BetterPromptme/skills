...
| ---: | ---: | --- | --- |
| 1 | Yes | Upload your photo (recommended: clear portrait with face fully visible) | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | Outfit photo | `--image-input-url <url>` or `--image-input-path <path>` |
