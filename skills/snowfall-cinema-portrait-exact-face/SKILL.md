...
Use the frontmatter's `name` as the positional argument (for this skill, use `snowfall-cinema-portrait-exact-face`).

Command form:

```bash
betterprompt generate snowfall-cinema-portrait-exact-face \
  [--image-input-url <url>] \
