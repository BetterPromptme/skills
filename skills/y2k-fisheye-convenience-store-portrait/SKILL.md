---
name: y2k-fisheye-convenience-store-portrait
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `y2k-fisheye-convenience-store-portrait`).

Command form:

```bash
betterprompt generate y2k-fisheye-convenience-store-portrait \
  [--image-input-url <url>] \
