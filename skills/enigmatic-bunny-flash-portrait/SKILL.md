...
| --- | ---: | --- | --- |
| `pose` | Optional | Describe your desired pose | `chin lifted confidently` |
| `makeup_style` | Optional | Describe your preferred makeup look | `soft natural glow` |
...
- Optional text inputs (use defaults if not provided by the human):
    - `pose` (default: `chin lifted confidently`)
  - `makeup_style` (default: `soft natural glow`)
- Required images:
