---
name: pink-angel-tennis-court-portrait
description: This prompt instructs an image generator to create a high-end, perfectly overhead fashion editorial scene on a monochromatic pink tennis court, centering a woman styled as a romantic “angel” in couture with coordinated props. It specifies camera angle, symmetrical composition, wardrobe, hair and makeup, wings, tennis-themed elements, lighting, textures, and technical quality, while also listing exclusions to prevent unwanted angles, clutter, low detail, or stylistic deviations. The expected result is an ultra-detailed, magazine-cover-quality, surreal luxury campaign image that blends tennis iconography with fantasy beauty editorial aesthetics.
...
This prompt instructs an image generator to create a high-end, perfectly overhead fashion editorial scene on a monochromatic pink tennis court, centering a woman styled as a romantic “angel” in couture with coordinated props. It specifies camera angle, symmetrical composition, wardrobe, hair and makeup, wings, tennis-themed elements, lighting, textures, and technical quality, while also listing exclusions to prevent unwanted angles, clutter, low detail, or stylistic deviations. The expected result is an ultra-detailed, magazine-cover-quality, surreal luxury campaign image that blends tennis iconography with fantasy beauty editorial aesthetics.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `pink-angel-tennis-court-portrait`).

Command form:

```bash
betterprompt generate pink-angel-tennis-court-portrait \
  [--image-input-url <url>] \
