...
| `Trip_length` | Required |  | (none) |
| `Budget_range` | Required |  | (none) |
| `Travel_dates` | Required |  | (none) |
| `Travel_style` | Required |  | (none) |
| `Non-negotiables` | Required |  | (none) |
| `Number_of_travelers` | Required |  | (none) |
| `Must-have_activities` | Required |  | (none) |
...
betterprompt generate 01985f73-549e-71fc-b8cd-16a471688670 \
  ...
  --input Travel_dates=<value> \
  --input Travel_style=<value> \
  --input Non-negotiables=<value> \
  --input Number_of_travelers=<value> \
  --input Must-have_activities=<value> \
  --model gpt-4.1-mini \
  --options '{}'
```
