...
| --- | ---: | --- | --- |
| `Name` | Optional | Type your name | `Noi` |
| `Channel` | Optional | Social media channels | `Instagram` |
| `Account_name` | Optional | Your social media account name | `noinguyentran` |
...
- Optional text inputs (use defaults if not provided by the human):
  ...
  - `Account_name` (default: `noinguyentran`)
- Required images:
