---
name: car-selfie-fan-portrait
description: This prompt instructs an image-generation model to produce a photorealistic, luxury-influencer style smartphone selfie of a stylish young woman seated in the front passenger seat of a modern high-end car, wearing a vintage-inspired football jersey customized to a specified country and flag/symbol. It defines precise requirements for pose, facial expression, beauty styling, hair, jersey materials and badge treatment, vehicle interior details, sunlight-driven lighting and reflections, camera perspective and composition, overall mood, and high-end editorial finishing, while also listing exclusions to prevent logos, artifacts, anatomical errors, and low-quality or unrealistic results.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `car-selfie-fan-portrait`).

Command form:

```bash
betterprompt generate car-selfie-fan-portrait \
  [--input <key>=<value>] \
  [--image-input-url <url>] \
