...
skillVersionId: 0197e31c-9f81-7414-aabf-716dcea895a2
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0197e31c-9f81-7414-aabf-716dcea895a2`).

Command form:

```bash
betterprompt generate 0197e31c-9f81-7414-aabf-716dcea895a2 \
  [--input <key>=<value>] \
  [--model <model>] \
