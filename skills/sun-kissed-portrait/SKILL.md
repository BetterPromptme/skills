...
Use the frontmatter's `name` as the positional argument (for this skill, use `sun-kissed-portrait`).

Command form:

```bash
betterprompt generate sun-kissed-portrait \
  [--image-input-url <url>] \
