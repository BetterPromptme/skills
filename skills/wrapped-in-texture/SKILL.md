...
skillVersionId: 01978246-ca46-73b2-a5e4-941075079dd3
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `01978246-ca46-73b2-a5e4-941075079dd3`).

Command form:

```bash
betterprompt generate 01978246-ca46-73b2-a5e4-941075079dd3 \
  [--input <key>=<value>] \
  [--model <model>] \
