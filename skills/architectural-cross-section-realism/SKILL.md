...
skillVersionId: 0197a60f-1acf-72a8-9c4a-64b4ceb5bcfd
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0197a60f-1acf-72a8-9c4a-64b4ceb5bcfd`).

Command form:

```bash
betterprompt generate 0197a60f-1acf-72a8-9c4a-64b4ceb5bcfd \
  [--input <key>=<value>] \
  [--model <model>] \
