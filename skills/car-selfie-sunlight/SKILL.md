...
Use the frontmatter's `name` as the positional argument (for this skill, use `car-selfie-sunlight`).

Command form:

```bash
betterprompt generate car-selfie-sunlight \
  [--image-input-url <url>] \
