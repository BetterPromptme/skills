---
name: golden-sky-cruise-portrait
description: This prompt instructs an image-generation system to produce an ultra-realistic, vertical, cinematic portrait set on a futuristic luxury sky-yacht deck above glowing sunset clouds, using the uploaded photo strictly as the facial identity reference so the final subject remains unmistakably the same person. It specifies pose, camera framing and lens feel, wardrobe and styling, environment details, lighting and color grading, and photorealistic rendering requirements, while explicitly prohibiting identity changes, artifacts, distortions, stylization, or low-quality outputs to ensure a high-end sci‑fi travel editorial result.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `golden-sky-cruise-portrait`).

Command form:

```bash
betterprompt generate golden-sky-cruise-portrait \
  [--image-input-url <url>] \
