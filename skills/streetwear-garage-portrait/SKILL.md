---
name: streetwear-garage-portrait
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `streetwear-garage-portrait`).

Command form:

```bash
betterprompt generate streetwear-garage-portrait \
  [--image-input-url <url>] \
