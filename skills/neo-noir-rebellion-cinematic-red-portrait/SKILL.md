...
| ---: | ---: | --- | --- |
| 1 | Yes | A photo of yourself (lead subject) | `--image-input-url <url>` or `--image-input-path <path>` |
...
Use the frontmatter's `name` as the positional argument (for this skill, use `neo-noir-rebellion-cinematic-red-portrait`).

Command form:

```bash
betterprompt generate neo-noir-rebellion-cinematic-red-portrait \
  [--image-input-url <url>] \
