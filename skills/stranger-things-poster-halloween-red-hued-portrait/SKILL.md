...
| ---: | ---: | --- | --- |
| 1 | Yes | A photo of you | `--image-input-url <url>` or `--image-input-path <path>` |
...
Use the frontmatter's `name` as the positional argument (for this skill, use `stranger-things-poster-halloween-red-hued-portrait`).

Command form:

```bash
betterprompt generate stranger-things-poster-halloween-red-hued-portrait \
  [--image-input-url <url>] \
