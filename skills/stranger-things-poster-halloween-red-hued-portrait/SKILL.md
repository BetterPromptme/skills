...
skillVersionId: 019a140a-5124-7335-a4b9-39f6f6d2f252
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a140a-5124-7335-a4b9-39f6f6d2f252`).

Command form:

```bash
betterprompt generate 019a140a-5124-7335-a4b9-39f6f6d2f252 \
  [--image-input-url <url>] \
