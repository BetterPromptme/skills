...
Use the frontmatter's `name` as the positional argument (for this skill, use `chanel-boutique-shopping`).

Command form:

```bash
betterprompt generate chanel-boutique-shopping \
  [--image-input-url <url>] \
