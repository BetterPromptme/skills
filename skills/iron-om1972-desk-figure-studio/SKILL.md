...
Use the frontmatter's `name` as the positional argument (for this skill, use `iron-om1972-desk-figure-studio`).

Command form:

```bash
betterprompt generate iron-om1972-desk-figure-studio \
  [--image-input-url <url>] \
