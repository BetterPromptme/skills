---
name: floral-and-festoon-portrait
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `floral-and-festoon-portrait`).

Command form:

```bash
betterprompt generate floral-and-festoon-portrait \
  [--image-input-url <url>] \
