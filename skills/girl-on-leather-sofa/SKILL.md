...
Use the frontmatter's `name` as the positional argument (for this skill, use `girl-on-leather-sofa`).

Command form:

```bash
betterprompt generate girl-on-leather-sofa \
  [--image-input-url <url>] \
