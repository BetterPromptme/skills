...
| ---: | ---: | --- | --- |
| 1 | Yes | Upload a clear photo of the exact product you want featured. | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | Upload your normal portrait photo you want to convert into a UGC image. | `--image-input-url <url>` or `--image-input-path <path>` |
