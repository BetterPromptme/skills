...
Use the frontmatter's `name` as the positional argument (for this skill, use `ugc-beauty-product-visualizer`).

Command form:

```bash
betterprompt generate ugc-beauty-product-visualizer \
  [--image-input-url <url>] \
