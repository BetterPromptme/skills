---
name: golden-hour-city-walk-portrait
description: This prompt directs an image-generation system to create an ultra-high-resolution, golden-hour fashion editorial portrait of a confident woman centered on a city crosswalk, specifying camera perspective, composition, styling (hair, makeup, outfit, accessories), and environmental details (trees, buildings, road markings) to achieve a cinematic luxury campaign look. It also defines lighting effects like backlit sun rays and natural lens flares, a cohesive warm color palette and texture realism, and includes exclusions to prevent unwanted conditions (e.g., nighttime, crowding, low quality, or stylistic distortions), resulting in a polished urban lifestyle photograph with consistent mood and visual clarity.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `golden-hour-city-walk-portrait`).

Command form:

```bash
betterprompt generate golden-hour-city-walk-portrait \
  [--image-input-url <url>] \
