...
| ---: | ---: | --- | --- |
| 1 | Yes | Image 1: Your photo | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | Image 2: Your desired Rhode phone case | `--image-input-url <url>` or `--image-input-path <path>` |
...
Use the frontmatter's `name` as the positional argument (for this skill, use `mirror-selfie-with-rhode-phone-case`).

Command form:

```bash
betterprompt generate mirror-selfie-with-rhode-phone-case \
  [--image-input-url <url>] \
