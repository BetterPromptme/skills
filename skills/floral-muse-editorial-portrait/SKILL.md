...
skillVersionId: 019a9ada-0b16-751e-93f4-1b381e067c0d
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a9ada-0b16-751e-93f4-1b381e067c0d`).

Command form:

```bash
betterprompt generate 019a9ada-0b16-751e-93f4-1b381e067c0d \
  [--image-input-url <url>] \
