---
name: surreal-mid-century-riviera-editorial
description: This prompt instructs an image model to turn the person in an uploaded photo into a recognizable yet surreal, elongated mid‑century Riviera fashion editorial caricature, specifying facial-identity constraints, exaggerated anatomy, deadpan expression, luxury vintage styling, an elegant animal co-star, a cinematic retro location with subtle background figures, and painterly oil-illustration textures, lighting, palette, and 4:5 magazine composition to produce a high-resolution, sophisticatedly absurd vintage-fashion illustration.
...
This prompt instructs an image model to turn the person in an uploaded photo into a recognizable yet surreal, elongated mid‑century Riviera fashion editorial caricature, specifying facial-identity constraints, exaggerated anatomy, deadpan expression, luxury vintage styling, an elegant animal co-star, a cinematic retro location with subtle background figures, and painterly oil-illustration textures, lighting, palette, and 4:5 magazine composition to produce a high-resolution, sophisticatedly absurd vintage-fashion illustration.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `surreal-mid-century-riviera-editorial`).

Command form:

```bash
betterprompt generate surreal-mid-century-riviera-editorial \
  [--image-input-url <url>] \
