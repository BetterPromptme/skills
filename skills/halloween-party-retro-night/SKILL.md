...
skillVersionId: 019a392f-fb9c-761b-986a-5e13e1855b2a
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a392f-fb9c-761b-986a-5e13e1855b2a`).

Command form:

```bash
betterprompt generate 019a392f-fb9c-761b-986a-5e13e1855b2a \
  [--image-input-url <url>] \
