...
Use the frontmatter's `name` as the positional argument (for this skill, use `hyper-pink-editorial-close-up-transformation`).

Command form:

```bash
betterprompt generate hyper-pink-editorial-close-up-transformation \
  [--image-input-url <url>] \
