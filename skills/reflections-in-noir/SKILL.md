...
Use the frontmatter's `name` as the positional argument (for this skill, use `reflections-in-noir`).

Command form:

```bash
betterprompt generate reflections-in-noir \
  [--image-input-url <url>] \
