---
name: gilded-evening-gala-portrait
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `gilded-evening-gala-portrait`).

Command form:

```bash
betterprompt generate gilded-evening-gala-portrait \
  [--image-input-url <url>] \
