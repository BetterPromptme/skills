...
Use the frontmatter's `name` as the positional argument (for this skill, use `elle-magazine-modern-minimalist-editorial-cover`).

Command form:

```bash
betterprompt generate elle-magazine-modern-minimalist-editorial-cover \
  [--image-input-url <url>] \
