...
skillVersionId: 019bb1bd-1eb4-741b-8776-ad029be3e4ca
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019bb1bd-1eb4-741b-8776-ad029be3e4ca`).

Command form:

```bash
betterprompt generate 019bb1bd-1eb4-741b-8776-ad029be3e4ca \
  [--image-input-url <url>] \
