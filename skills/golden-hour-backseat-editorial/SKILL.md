...
Use the frontmatter's `name` as the positional argument (for this skill, use `golden-hour-backseat-editorial`).

Command form:

```bash
betterprompt generate golden-hour-backseat-editorial \
  [--image-input-url <url>] \
