...
skillVersionId: 0198a6cf-a2bd-7300-bf0a-02cb9d1f3aaf
---

## What it does

This prompt instructs an AI to recreate the subjects shown in an input image as high-quality, Apple Memoji-inspired 3D emoji avatars, preserving the original pose, expressions, interactions, and all key visual details (such as clothing, accessories, facial features, and props), and to deliver the finished characters fully visible on a transparent background in a soft, rounded, smoothly shaded cartoon style.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0198a6cf-a2bd-7300-bf0a-02cb9d1f3aaf`).

Command form:

```bash
betterprompt generate 0198a6cf-a2bd-7300-bf0a-02cb9d1f3aaf \
  [--image-input-url <url>] \
