...
Use the frontmatter's `name` as the positional argument (for this skill, use `full-body-memoji-avatar-recreator`).

Command form:

```bash
betterprompt generate full-body-memoji-avatar-recreator \
  [--image-input-url <url>] \
