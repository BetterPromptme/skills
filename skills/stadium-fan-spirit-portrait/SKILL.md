---
name: stadium-fan-spirit-portrait
description: This prompt instructs an image-generation system to create a high-resolution, vertical editorial lifestyle portrait of a woman in a packed Brazilian national team match inside a large modern football stadium, photographed over-the-shoulder with the illuminated pitch and massive crowd clearly visible. It specifies detailed subject appearance, wardrobe (including precise jersey text and number), lighting, color palette, stadium atmosphere, and photographic style, while also listing exclusions to prevent common errors like empty stands, incorrect details, blur, or unrealistic anatomy. The intended outcome is a cinematic, realistic matchday fan-experience image that blends travel, sports culture, and contemporary portraiture with strong national colors and energy.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `stadium-fan-spirit-portrait`).

Command form:

```bash
betterprompt generate stadium-fan-spirit-portrait \
  [--image-input-url <url>] \
