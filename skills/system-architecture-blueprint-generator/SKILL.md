...
| --- | ---: | --- | --- |
| `Project_Description` | Required |  | (none) |
| `Expected_User_Base_Target` | Required |  | (none) |
| `Expected_User_Base_Initial` | Required |  | (none) |
...
- Required text inputs:
    - `Project_Description`
  - `Expected_User_Base_Target`
  - `Expected_User_Base_Initial`
