...
skillVersionId: 0196ecac-1815-7bd2-a7b9-88a5676a1f09
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0196ecac-1815-7bd2-a7b9-88a5676a1f09`).

Command form:

```bash
betterprompt generate 0196ecac-1815-7bd2-a7b9-88a5676a1f09 \
  [--image-input-url <url>] \
