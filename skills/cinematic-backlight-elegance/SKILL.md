...
skillVersionId: 0199ebf1-dfa1-79fe-bbff-89b69a8ed17b
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0199ebf1-dfa1-79fe-bbff-89b69a8ed17b`).

Command form:

```bash
betterprompt generate 0199ebf1-dfa1-79fe-bbff-89b69a8ed17b \
  [--image-input-url <url>] \
