...
Use the frontmatter's `name` as the positional argument (for this skill, use `cinematic-backlight-elegance`).

Command form:

```bash
betterprompt generate cinematic-backlight-elegance \
  [--image-input-url <url>] \
