...
Use the frontmatter's `name` as the positional argument (for this skill, use `expresso-album-cover-studio-portrait-style`).

Command form:

```bash
betterprompt generate expresso-album-cover-studio-portrait-style \
  [--image-input-url <url>] \
