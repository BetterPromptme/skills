...
Use the frontmatter's `name` as the positional argument (for this skill, use `a-little-bit-dramatic-platinum-blonde-hair-edition`).

Command form:

```bash
betterprompt generate a-little-bit-dramatic-platinum-blonde-hair-edition \
  [--image-input-url <url>] \
