...
| ---: | ---: | --- | --- |
| 1 | Yes | The photo of you | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | The photo of your crush/friend/anyone you want | `--image-input-url <url>` or `--image-input-path <path>` |
