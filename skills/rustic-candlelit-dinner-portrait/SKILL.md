...
skillVersionId: 019c9b09-8a1e-7548-8a24-170456130d79
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019c9b09-8a1e-7548-8a24-170456130d79`).

Command form:

```bash
betterprompt generate 019c9b09-8a1e-7548-8a24-170456130d79 \
  [--image-input-url <url>] \
