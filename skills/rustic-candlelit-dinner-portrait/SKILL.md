...
Use the frontmatter's `name` as the positional argument (for this skill, use `rustic-candlelit-dinner-portrait`).

Command form:

```bash
betterprompt generate rustic-candlelit-dinner-portrait \
  [--image-input-url <url>] \
