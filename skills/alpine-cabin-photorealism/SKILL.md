...
skillVersionId: 019b0b9f-d0cd-7498-a34c-63aa53abd70a
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019b0b9f-d0cd-7498-a34c-63aa53abd70a`).

Command form:

```bash
betterprompt generate 019b0b9f-d0cd-7498-a34c-63aa53abd70a \
  [--image-input-url <url>] \
