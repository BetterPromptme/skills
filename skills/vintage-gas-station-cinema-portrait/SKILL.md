...
Use the frontmatter's `name` as the positional argument (for this skill, use `vintage-gas-station-cinema-portrait`).

Command form:

```bash
betterprompt generate vintage-gas-station-cinema-portrait \
  [--image-input-url <url>] \
