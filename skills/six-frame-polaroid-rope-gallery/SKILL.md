...
Use the frontmatter's `name` as the positional argument (for this skill, use `six-frame-polaroid-rope-gallery`).

Command form:

```bash
betterprompt generate six-frame-polaroid-rope-gallery \
  [--image-input-url <url>] \
