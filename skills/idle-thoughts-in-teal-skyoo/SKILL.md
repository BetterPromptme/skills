...
skillVersionId: 0199b2ec-ce35-7a11-a2d6-929a69cc9ef5
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0199b2ec-ce35-7a11-a2d6-929a69cc9ef5`).

Command form:

```bash
betterprompt generate 0199b2ec-ce35-7a11-a2d6-929a69cc9ef5 \
  [--image-input-url <url>] \
