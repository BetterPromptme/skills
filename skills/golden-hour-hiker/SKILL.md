...
Use the frontmatter's `name` as the positional argument (for this skill, use `golden-hour-hiker`).

Command form:

```bash
betterprompt generate golden-hour-hiker \
  [--image-input-url <url>] \
