...
Use the frontmatter's `name` as the positional argument (for this skill, use `natural-lace-garden-editorial`).

Command form:

```bash
betterprompt generate natural-lace-garden-editorial \
  [--image-input-url <url>] \
