...
| ---: | ---: | --- | --- |
| 1 | Yes | Photo of a man (keep the real face for best result if it is a portrait) | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | Photo of a woman (keep the real face for best result if it is a portrait) | `--image-input-url <url>` or `--image-input-path <path>` |
