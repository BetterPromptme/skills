...
| --- | ---: | --- | --- |
| `skill_level` | Required | Beginner, intermediate, or advanced. | (none) |
| `learning_goal` | Required | Travel, daily conversation, professional use, or full fluency. | (none) |
| `target_language` | Optional | The language you want to learn | `English` |
