...
| --- | ---: | --- | --- |
| `Gender` | Required | male or female (to adjust pose + energy naturally) | (none) |
...
| ---: | ---: | --- | --- |
| 1 | Yes | The original portrait | `--image-input-url <url>` or `--image-input-base64 <base64>` or `--image-input-path <absolute path to image>` |
...
- Required text inputs:
    - `Gender`
- Required images:
  - **Exactly 1** images: image 1 (The original portrait). Images must be provided in this order.
...
If any required text input or the required images are missing, **ask the human for what's missing**. Do not assume or fabricate values. Tell the human: **"Please provide images in this order: image 1 (The original portrait)"**.
