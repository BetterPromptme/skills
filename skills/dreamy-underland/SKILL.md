...
skillVersionId: 019a9acb-f784-732b-b86e-3e8a881bb2bb
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a9acb-f784-732b-b86e-3e8a881bb2bb`).

Command form:

```bash
betterprompt generate 019a9acb-f784-732b-b86e-3e8a881bb2bb \
  [--image-input-url <url>] \
