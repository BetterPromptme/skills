...
skillVersionId: 019c2307-4b49-708b-bce7-4b67bafc9602
---

## What it does

This prompt instructs an image generator/editor to produce a highly photorealistic, warm-lit mirror-selfie portrait in a luxury bathroom or dressing space, with strict constraints to preserve the subject’s exact identity and natural features. It specifies the vertical mid‑torso framing, symmetrical upscale interior elements (arched frames, marble counter, modern faucet), the subject’s pose (hair touch and compact held outward), wardrobe and accessories (structured black dress, rectangular gold earrings), and warm golden lighting and neutral palette, resulting in a polished, editorial lifestyle image with no stylization, added text, or facial alteration.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019c2307-4b49-708b-bce7-4b67bafc9602`).

Command form:

```bash
betterprompt generate 019c2307-4b49-708b-bce7-4b67bafc9602 \
  [--image-input-url <url>] \
