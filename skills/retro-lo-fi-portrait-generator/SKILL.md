...
| ---: | ---: | --- | --- |
| 1 | Yes | Your photo that you want to transform into a Retro Lo-Fi Portrait. | `--image-input-url <url>` or `--image-input-base64 <base64>` or `--image-input-path <absolute path to image>` |
