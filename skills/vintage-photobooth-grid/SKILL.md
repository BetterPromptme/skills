...
Use the frontmatter's `name` as the positional argument (for this skill, use `vintage-photobooth-grid`).

Command form:

```bash
betterprompt generate vintage-photobooth-grid \
  [--image-input-url <url>] \
