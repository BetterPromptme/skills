...
skillVersionId: 019a47a8-adc7-750a-9b33-bfd3e20ca20a
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a47a8-adc7-750a-9b33-bfd3e20ca20a`).

Command form:

```bash
betterprompt generate 019a47a8-adc7-750a-9b33-bfd3e20ca20a \
  [--image-input-url <url>] \
