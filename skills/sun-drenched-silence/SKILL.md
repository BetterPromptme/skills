---
name: sun-drenched-silence
description: This prompt instructs an AI to generate a high-resolution, photorealistic vertical close-up beach portrait with a just-out-of-the-water look, specifying the subject’s wet hair, sunlit skin with visible droplets, calm direct-gaze expression, tropical off-shoulder outfit, and simple accessories, all shot in bright midday light with shallow depth of field and a softly blurred ocean horizon; the intended outcome is an editorial-polished yet natural coastal image that preserves the subject’s exact facial identity and realistic textures without smoothing or distortion.
...
This prompt instructs an AI to generate a high-resolution, photorealistic vertical close-up beach portrait with a just-out-of-the-water look, specifying the subject’s wet hair, sunlit skin with visible droplets, calm direct-gaze expression, tropical off-shoulder outfit, and simple accessories, all shot in bright midday light with shallow depth of field and a softly blurred ocean horizon; the intended outcome is an editorial-polished yet natural coastal image that preserves the subject’s exact facial identity and realistic textures without smoothing or distortion.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `sun-drenched-silence`).

Command form:

```bash
betterprompt generate sun-drenched-silence \
  [--image-input-url <url>] \
