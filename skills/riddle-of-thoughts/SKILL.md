...
skillVersionId: 019a396d-cbff-702e-af4e-193d6bffa7cc
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a396d-cbff-702e-af4e-193d6bffa7cc`).

Command form:

```bash
betterprompt generate 019a396d-cbff-702e-af4e-193d6bffa7cc \
  [--image-input-url <url>] \
