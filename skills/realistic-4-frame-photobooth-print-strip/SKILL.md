...
| ---: | ---: | --- | --- |
| 1 | Yes | Upload reference photo for frame 1 of the strip | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | Upload reference photo for frame 2 of the strip | `--image-input-url <url>` or `--image-input-path <path>` |
| 3 | Yes | Upload reference photo for frame 3 of the strip | `--image-input-url <url>` or `--image-input-path <path>` |
| 4 | Yes | Upload reference photo for frame 4 of the strip | `--image-input-url <url>` or `--image-input-path <path>` |
