...
Use the frontmatter's `name` as the positional argument (for this skill, use `golden-hour-triptych-portrait`).

Command form:

```bash
betterprompt generate golden-hour-triptych-portrait \
  [--image-input-url <url>] \
