---
name: redhead-enjoying-cheesecake
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `redhead-enjoying-cheesecake`).

Command form:

```bash
betterprompt generate redhead-enjoying-cheesecake \
  [--image-input-url <url>] \
