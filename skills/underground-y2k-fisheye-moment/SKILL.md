...
Use the frontmatter's `name` as the positional argument (for this skill, use `underground-y2k-fisheye-moment`).

Command form:

```bash
betterprompt generate underground-y2k-fisheye-moment \
  [--image-input-url <url>] \
