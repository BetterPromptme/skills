...
Use the frontmatter's `name` as the positional argument (for this skill, use `the-skeleton-leaf`).

Command form:

```bash
betterprompt generate the-skeleton-leaf \
  [--image-input-url <url>] \
