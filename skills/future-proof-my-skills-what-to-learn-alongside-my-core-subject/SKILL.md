...
Use the frontmatter's `name` as the positional argument (for this skill, use `future-proof-my-skills-what-to-learn-alongside-my-core-subject`).

Command form:

```bash
betterprompt generate future-proof-my-skills-what-to-learn-alongside-my-core-subject \
  [--input <key>=<value>] \
  [--model <model>] \
