...
skillVersionId: 019780ed-4036-70a0-a985-ad0919df7721
---

## What it does

This prompt asks the AI to act as a career-focused advisor for a student in a specified major and subject, and to recommend complementary skills to build alongside that subject to improve future employability. The result is a curated set of adjacent technical, analytical, communication, and professional skills tailored to the student’s field, highlighting areas that increase versatility and competitiveness in the job market.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019780ed-4036-70a0-a985-ad0919df7721`).

Command form:

```bash
betterprompt generate 019780ed-4036-70a0-a985-ad0919df7721 \
  [--input <key>=<value>] \
  [--model <model>] \
