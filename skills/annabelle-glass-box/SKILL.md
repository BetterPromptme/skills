...
skillVersionId: 019a2df0-1f1a-7dcb-a017-0ba303687958
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a2df0-1f1a-7dcb-a017-0ba303687958`).

Command form:

```bash
betterprompt generate 019a2df0-1f1a-7dcb-a017-0ba303687958 \
  [--image-input-url <url>] \
