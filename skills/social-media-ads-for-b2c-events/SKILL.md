...
skillVersionId: 0198a235-020b-7f3c-a03f-fbf08e9d4e85
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0198a235-020b-7f3c-a03f-fbf08e9d4e85`).

Command form:

```bash
betterprompt generate 0198a235-020b-7f3c-a03f-fbf08e9d4e85 \
  [--input <key>=<value>] \
  [--model <model>] \
