...
Use the frontmatter's `name` as the positional argument (for this skill, use `paris-flash-night-portrait-at-the-eiffel-tower`).

Command form:

```bash
betterprompt generate paris-flash-night-portrait-at-the-eiffel-tower \
  [--image-input-url <url>] \
