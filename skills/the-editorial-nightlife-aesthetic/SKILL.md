...
Use the frontmatter's `name` as the positional argument (for this skill, use `the-editorial-nightlife-aesthetic`).

Command form:

```bash
betterprompt generate the-editorial-nightlife-aesthetic \
  [--image-input-url <url>] \
