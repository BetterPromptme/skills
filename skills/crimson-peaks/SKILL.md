...
skillVersionId: 019a52cf-0632-74f8-8a48-fce45aec6525
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a52cf-0632-74f8-8a48-fce45aec6525`).

Command form:

```bash
betterprompt generate 019a52cf-0632-74f8-8a48-fce45aec6525 \
  [--image-input-url <url>] \
