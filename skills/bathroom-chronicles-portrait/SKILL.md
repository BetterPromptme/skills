---
name: bathroom-chronicles-portrait
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `bathroom-chronicles-portrait`).

Command form:

```bash
betterprompt generate bathroom-chronicles-portrait \
  [--image-input-url <url>] \
