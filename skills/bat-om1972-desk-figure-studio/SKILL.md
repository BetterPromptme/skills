...
Use the frontmatter's `name` as the positional argument (for this skill, use `bat-om1972-desk-figure-studio`).

Command form:

```bash
betterprompt generate bat-om1972-desk-figure-studio \
  [--image-input-url <url>] \
