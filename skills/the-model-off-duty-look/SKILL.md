...
Use the frontmatter's `name` as the positional argument (for this skill, use `the-model-off-duty-look`).

Command form:

```bash
betterprompt generate the-model-off-duty-look \
  [--image-input-url <url>] \
