...
Use the frontmatter's `name` as the positional argument (for this skill, use `morning-routine-selfie`).

Command form:

```bash
betterprompt generate morning-routine-selfie \
  [--image-input-url <url>] \
