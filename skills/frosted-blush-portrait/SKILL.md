...
Use the frontmatter's `name` as the positional argument (for this skill, use `frosted-blush-portrait`).

Command form:

```bash
betterprompt generate frosted-blush-portrait \
  [--image-input-url <url>] \
