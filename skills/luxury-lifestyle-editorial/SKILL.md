---
name: luxury-lifestyle-editorial
description: This prompt instructs an AI image generator to produce a photorealistic, high-end hotel-suite style bathroom mirror selfie using an input photo as the identity reference, with strict constraints to preserve the subject’s exact face, hair, and expression. It specifies the vertical mirror-selfie framing, seated side-profile pose, smartphone placement, outfit and accessories, and a warm beige marble luxury bathroom environment with clean geometry and soft diffused lighting. The expected result is a sharp, realistic, minimally styled luxury lifestyle photograph featuring crisp textures (lace, marble, jewelry) and an uncluttered, polished aesthetic without filters or facial alterations.
skillVersionId: 019c29b4-be1f-7070-8c63-697c44fb8f6f
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019c29b4-be1f-7070-8c63-697c44fb8f6f`).

Command form:

```bash
betterprompt generate 019c29b4-be1f-7070-8c63-697c44fb8f6f \
  [--image-input-url <url>] \
