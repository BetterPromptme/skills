---
name: cherry-orchard-portrait-muse
description: This prompt instructs an image-generation/editing model to create an ultra-realistic, vertical (2:3) close-up fashion portrait in a golden-hour cherry orchard while using the uploaded photo strictly as the facial identity reference, preserving the subject’s exact features and natural proportions. It specifies wardrobe and accessories (cherry-print white headscarf, gold hoops, white lace camisole), a candid elegant pose involving cherries near the face, a warm romantic editorial mood, and detailed lighting/color/texture requirements. The expected outcome is a photoreal, shallow–depth-of-field DSLR-style 85mm portrait with sharp focus on the face and key details, cherry branches framing the subject, and a softly blurred orchard background.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `cherry-orchard-portrait-muse`).

Command form:

```bash
betterprompt generate cherry-orchard-portrait-muse \
  [--image-input-url <url>] \
