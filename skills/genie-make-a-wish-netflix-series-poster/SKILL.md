...
Use the frontmatter's `name` as the positional argument (for this skill, use `genie-make-a-wish-netflix-series-poster`).

Command form:

```bash
betterprompt generate genie-make-a-wish-netflix-series-poster \
  [--image-input-url <url>] \
