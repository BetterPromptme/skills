...
Use the frontmatter's `name` as the positional argument (for this skill, use `sunlit-gaze-natural-high-contrast-headshot`).

Command form:

```bash
betterprompt generate sunlit-gaze-natural-high-contrast-headshot \
  [--image-input-url <url>] \
