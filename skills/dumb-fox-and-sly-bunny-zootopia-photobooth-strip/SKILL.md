...
Use the frontmatter's `name` as the positional argument (for this skill, use `dumb-fox-and-sly-bunny-zootopia-photobooth-strip`).

Command form:

```bash
betterprompt generate dumb-fox-and-sly-bunny-zootopia-photobooth-strip \
  [--image-input-url <url>] \
