---
name: a-summer-day-at-the-eiffel
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `a-summer-day-at-the-eiffel`).

Command form:

```bash
betterprompt generate a-summer-day-at-the-eiffel \
  [--image-input-url <url>] \
