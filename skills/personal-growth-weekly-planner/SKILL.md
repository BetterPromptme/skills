...
skillVersionId: 0198c0b3-c01c-709d-bf28-53429ec51ffb
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0198c0b3-c01c-709d-bf28-53429ec51ffb`).

Command form:

```bash
betterprompt generate 0198c0b3-c01c-709d-bf28-53429ec51ffb \
  [--input <key>=<value>] \
  [--model <model>] \
