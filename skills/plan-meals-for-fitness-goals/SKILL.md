...
skillVersionId: 0196f702-bff5-7694-b50a-f2ceda9b903b
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0196f702-bff5-7694-b50a-f2ceda9b903b`).

Command form:

```bash
betterprompt generate 0196f702-bff5-7694-b50a-f2ceda9b903b \
  [--input <key>=<value>] \
  [--model <model>] \
