...
Use the frontmatter's `name` as the positional argument (for this skill, use `denim-and-white-editorial-portrait`).

Command form:

```bash
betterprompt generate denim-and-white-editorial-portrait \
  [--image-input-url <url>] \
