...
skillVersionId: 019a398f-03ce-75ea-939b-39f211db1e5a
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a398f-03ce-75ea-939b-39f211db1e5a`).

Command form:

```bash
betterprompt generate 019a398f-03ce-75ea-939b-39f211db1e5a \
  [--image-input-url <url>] \
