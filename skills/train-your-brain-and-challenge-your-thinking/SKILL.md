...
Use the frontmatter's `name` as the positional argument (for this skill, use `train-your-brain-and-challenge-your-thinking`).

Command form:

```bash
betterprompt generate train-your-brain-and-challenge-your-thinking \
  [--input <key>=<value>] \
  [--model <model>] \
