...
Use the frontmatter's `name` as the positional argument (for this skill, use `paris-midnight-cinema-portrait`).

Command form:

```bash
betterprompt generate paris-midnight-cinema-portrait \
  [--image-input-url <url>] \
