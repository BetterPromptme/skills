...
Use the frontmatter's `name` as the positional argument (for this skill, use `sun-kissed-solitude`).

Command form:

```bash
betterprompt generate sun-kissed-solitude \
  [--image-input-url <url>] \
