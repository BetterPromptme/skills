---
name: cyber-y2k-night-aesthetic
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `cyber-y2k-night-aesthetic`).

Command form:

```bash
betterprompt generate cyber-y2k-night-aesthetic \
  [--image-input-url <url>] \
