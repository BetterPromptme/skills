---
name: seoul-streetwear-night-portrait
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `seoul-streetwear-night-portrait`).

Command form:

```bash
betterprompt generate seoul-streetwear-night-portrait \
  [--image-input-url <url>] \
