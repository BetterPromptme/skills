...
Use the frontmatter's `name` as the positional argument (for this skill, use `stranger-things-group-fisheye-selfie`).

Command form:

```bash
betterprompt generate stranger-things-group-fisheye-selfie \
  [--image-input-url <url>] \
