...
Use the frontmatter's `name` as the positional argument (for this skill, use `moody-cafe-portrait-shot`).

Command form:

```bash
betterprompt generate moody-cafe-portrait-shot \
  [--image-input-url <url>] \
