...
Use the frontmatter's `name` as the positional argument (for this skill, use `winter-dive-goblin-inspired-triptych-portrait`).

Command form:

```bash
betterprompt generate winter-dive-goblin-inspired-triptych-portrait \
  [--image-input-url <url>] \
