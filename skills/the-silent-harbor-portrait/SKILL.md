...
skillVersionId: 019c9b02-8798-736a-accf-ec9b7f278b78
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019c9b02-8798-736a-accf-ec9b7f278b78`).

Command form:

```bash
betterprompt generate 019c9b02-8798-736a-accf-ec9b7f278b78 \
  [--image-input-url <url>] \
