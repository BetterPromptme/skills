...
Use the frontmatter's `name` as the positional argument (for this skill, use `night-luxe-red-interior`).

Command form:

```bash
betterprompt generate night-luxe-red-interior \
  [--image-input-url <url>] \
