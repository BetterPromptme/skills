---
name: classical-european-balcony-elegance
description: This prompt instructs an image-generation model to create an ultra-photorealistic, magazine-quality luxury fashion editorial portrait: a full-body, centered female subject posed symmetrically in an open French-door balcony doorway inside a historic European hotel suite, with meticulously specified styling, architecture, lighting, composition, and technical camera qualities to achieve a high-end couture travel-campaign look, while explicitly excluding common visual flaws and artifacts to ensure a polished, cinematic final result.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `classical-european-balcony-elegance`).

Command form:

```bash
betterprompt generate classical-european-balcony-elegance \
  [--image-input-url <url>] \
