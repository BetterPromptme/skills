...
Use the frontmatter's `name` as the positional argument (for this skill, use `sunburned-blush-selfie`).

Command form:

```bash
betterprompt generate sunburned-blush-selfie \
  [--image-input-url <url>] \
