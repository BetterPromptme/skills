---
name: mountain-summit-hiking-selfie
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `mountain-summit-hiking-selfie`).

Command form:

```bash
betterprompt generate mountain-summit-hiking-selfie \
  [--image-input-url <url>] \
