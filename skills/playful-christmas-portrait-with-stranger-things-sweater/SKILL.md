...
Use the frontmatter's `name` as the positional argument (for this skill, use `playful-christmas-portrait-with-stranger-things-sweater`).

Command form:

```bash
betterprompt generate playful-christmas-portrait-with-stranger-things-sweater \
  [--image-input-url <url>] \
