...
skillVersionId: 019b497e-ebeb-70df-91a2-5345b70dfb17
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019b497e-ebeb-70df-91a2-5345b70dfb17`).

Command form:

```bash
betterprompt generate 019b497e-ebeb-70df-91a2-5345b70dfb17 \
  [--image-input-url <url>] \
