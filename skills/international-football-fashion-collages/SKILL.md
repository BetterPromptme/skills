---
name: international-football-fashion-collages
description: This prompt directs an image model to produce a photoreal, luxury sports-fashion editorial scene centered on one woman as a dominant close-up portrait styled in a football kit themed to a chosen country, while also featuring three perfectly matched miniature “clone” versions of her posed on her palm, on a football, and celebrating with a named supporter scarf. It specifies national color and symbol customization, premium fabric and accessory detail, golden-hour cinematic lighting, shallow-depth magazine-cover composition, and a clean country-associated background, while explicitly rejecting identity drift, artifacts, logos, anatomy errors, and low-quality rendering to ensure a high-end campaign outcome.
...
This prompt directs an image model to produce a photoreal, luxury sports-fashion editorial scene centered on one woman as a dominant close-up portrait styled in a football kit themed to a chosen country, while also featuring three perfectly matched miniature “clone” versions of her posed on her palm, on a football, and celebrating with a named supporter scarf. It specifies national color and symbol customization, premium fabric and accessory detail, golden-hour cinematic lighting, shallow-depth magazine-cover composition, and a clean country-associated background, while explicitly rejecting identity drift, artifacts, logos, anatomy errors, and low-quality rendering to ensure a high-end campaign outcome.
...
| `COUNTRY_NAME` | Required |  | (none) |
| `COUNTRY_FLAG_OR_SYMBOL` | Required |  | (none) |
...
Use the frontmatter's `name` as the positional argument (for this skill, use `international-football-fashion-collages`).

Command form:

```bash
betterprompt generate international-football-fashion-collages \
  [--input <key>=<value>] \
  [--image-input-url <url>] \
...
betterprompt generate international-football-fashion-collages \
  ...
  --input COUNTRY_FLAG_OR_SYMBOL=<value> \
