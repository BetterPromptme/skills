---
name: hairstyle-analysis-graphic
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `hairstyle-analysis-graphic`).

Command form:

```bash
betterprompt generate hairstyle-analysis-graphic \
  [--image-input-url <url>] \
