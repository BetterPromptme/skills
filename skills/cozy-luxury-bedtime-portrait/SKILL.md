...
skillVersionId: 019b4a9d-45e3-749c-bc14-ca56a55b3369
---

## What it does

This prompt directs an image model to generate a calm, intimate horizontal medium close-up lifestyle portrait of a woman reclining on white bedding, emphasizing realistic facial identity, natural skin texture, and a serene expression. It specifies a slightly top-down camera angle, soft diffused editorial lighting, minimal background, and cohesive pale pink satin sleepwear details (including a pushed-up sleep mask and matching robe with feathered cuffs) with a subtle gold bracelet. The intended outcome is a polished “cozy luxury” bedtime/self-care image that looks relaxed and unposed, avoids heavy retouching or dramatic styling, and remains strictly within a female-only scope.
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019b4a9d-45e3-749c-bc14-ca56a55b3369`).

Command form:

```bash
betterprompt generate 019b4a9d-45e3-749c-bc14-ca56a55b3369 \
  [--image-input-url <url>] \
