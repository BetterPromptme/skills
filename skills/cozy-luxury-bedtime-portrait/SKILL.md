...
Use the frontmatter's `name` as the positional argument (for this skill, use `cozy-luxury-bedtime-portrait`).

Command form:

```bash
betterprompt generate cozy-luxury-bedtime-portrait \
  [--image-input-url <url>] \
