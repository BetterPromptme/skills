...
| ---: | ---: | --- | --- |
| 1 | Yes | Image 1: Upload your photo here | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | Image 2: Upload photo of your bag | `--image-input-url <url>` or `--image-input-path <path>` |
