...
| ---: | ---: | --- | --- |
| 1 | Yes | Image 1: Upload your photo here | `--image-input-url <url>` or `--image-input-base64 <base64>` or `--image-input-path <absolute path to image>` |
| 2 | Yes | Image 2: Upload photo of your bag | `--image-input-url <url>` or `--image-input-base64 <base64>` or `--image-input-path <absolute path to image>` |
...
- Required images:
  - **Exactly 2** images: image 1 (Image 1: Upload your photo here) and image 2 (Image 2: Upload photo of your bag). Images must be provided in this order.
...
If the required images are missing, **ask the human for what's missing**. Do not assume or fabricate values. Tell the human: **"Please provide images in this order: image 1 (Image 1: Upload your photo here) and image 2 (Image 2: Upload photo of your bag)"**.
