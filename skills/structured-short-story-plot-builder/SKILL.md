...
skillVersionId: 0197d3a3-803e-7ec6-9967-ac657d0cc213
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0197d3a3-803e-7ec6-9967-ac657d0cc213`).

Command form:

```bash
betterprompt generate 0197d3a3-803e-7ec6-9967-ac657d0cc213 \
  [--input <key>=<value>] \
  [--model <model>] \
