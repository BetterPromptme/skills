...
Use the frontmatter's `name` as the positional argument (for this skill, use `nighttime-direct-flash-selfie`).

Command form:

```bash
betterprompt generate nighttime-direct-flash-selfie \
  [--image-input-url <url>] \
