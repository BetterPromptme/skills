...
skillVersionId: 019be958-2cf7-731d-b330-beaecaa68daf
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019be958-2cf7-731d-b330-beaecaa68daf`).

Command form:

```bash
betterprompt generate 019be958-2cf7-731d-b330-beaecaa68daf \
  [--image-input-url <url>] \
