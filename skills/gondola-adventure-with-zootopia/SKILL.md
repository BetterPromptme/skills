...
skillVersionId: 019ae780-8592-765a-ab4e-8783d1ac430f
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019ae780-8592-765a-ab4e-8783d1ac430f`).

Command form:

```bash
betterprompt generate 019ae780-8592-765a-ab4e-8783d1ac430f \
  [--image-input-url <url>] \
