...
Use the frontmatter's `name` as the positional argument (for this skill, use `a-parisian-afternoon-portrait`).

Command form:

```bash
betterprompt generate a-parisian-afternoon-portrait \
  [--image-input-url <url>] \
