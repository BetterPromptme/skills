...
| ---: | ---: | --- | --- |
| 1 | Yes | your childhood portrait | `--image-input-url <url>` or `--image-input-path <path>` |
| 2 | Yes | your present-day portrait | `--image-input-url <url>` or `--image-input-path <path>` |
