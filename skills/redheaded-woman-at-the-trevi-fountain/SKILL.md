---
name: redheaded-woman-at-the-trevi-fountain
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `redheaded-woman-at-the-trevi-fountain`).

Command form:

```bash
betterprompt generate redheaded-woman-at-the-trevi-fountain \
  [--image-input-url <url>] \
