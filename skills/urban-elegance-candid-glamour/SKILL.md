...
skillVersionId: 019c51cd-7958-72bd-9abc-d4bd36f93367
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019c51cd-7958-72bd-9abc-d4bd36f93367`).

Command form:

```bash
betterprompt generate 019c51cd-7958-72bd-9abc-d4bd36f93367 \
  [--image-input-url <url>] \
