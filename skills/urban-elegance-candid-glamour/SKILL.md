...
Use the frontmatter's `name` as the positional argument (for this skill, use `urban-elegance-candid-glamour`).

Command form:

```bash
betterprompt generate urban-elegance-candid-glamour \
  [--image-input-url <url>] \
