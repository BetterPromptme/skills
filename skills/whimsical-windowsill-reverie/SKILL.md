...
skillVersionId: 0196f783-8fd8-7850-a0a1-3643f0567d22
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0196f783-8fd8-7850-a0a1-3643f0567d22`).

Command form:

```bash
betterprompt generate 0196f783-8fd8-7850-a0a1-3643f0567d22 \
  [--input <key>=<value>] \
  [--model <model>] \
