...
Use the frontmatter's `name` as the positional argument (for this skill, use `macbook-selfie-screen-reflection`).

Command form:

```bash
betterprompt generate macbook-selfie-screen-reflection \
  [--image-input-url <url>] \
