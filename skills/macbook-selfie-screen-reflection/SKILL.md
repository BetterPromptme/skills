...
skillVersionId: 019a0b52-3718-70d6-b9bf-dacbcabba7d6
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a0b52-3718-70d6-b9bf-dacbcabba7d6`).

Command form:

```bash
betterprompt generate 019a0b52-3718-70d6-b9bf-dacbcabba7d6 \
  [--image-input-url <url>] \
