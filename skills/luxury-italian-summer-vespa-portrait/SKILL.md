---
name: luxury-italian-summer-vespa-portrait
description: 
...
Use the frontmatter's `name` as the positional argument (for this skill, use `luxury-italian-summer-vespa-portrait`).

Command form:

```bash
betterprompt generate luxury-italian-summer-vespa-portrait \
  [--image-input-url <url>] \
