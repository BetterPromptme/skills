...
skillVersionId: 0197cf35-0999-79e7-b54e-0b35c4dc6484
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0197cf35-0999-79e7-b54e-0b35c4dc6484`).

Command form:

```bash
betterprompt generate 0197cf35-0999-79e7-b54e-0b35c4dc6484 \
  [--image-input-url <url>] \
