...
skillVersionId: 01996fb3-c94b-7777-b328-cfc0ca754958
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `01996fb3-c94b-7777-b328-cfc0ca754958`).

Command form:

```bash
betterprompt generate 01996fb3-c94b-7777-b328-cfc0ca754958 \
  [--image-input-url <url>] \
