---
name: blushed-summer-portrait
description: This prompt instructs an image model to generate an ultra-realistic, softly lit vertical chest-up beauty selfie with a calm, minimal Scandinavian editorial feel set in a warm rustic wooden interior with subtle tropical reflections. It tightly specifies identity preservation, facial features, makeup, hair, outfit, accessories, background elements, lighting direction, color palette, textures, and overall mood to produce a serene, intimate, high-resolution skincare-style portrait without unrealistic reshaping or over-smoothing.
...
This prompt instructs an image model to generate an ultra-realistic, softly lit vertical chest-up beauty selfie with a calm, minimal Scandinavian editorial feel set in a warm rustic wooden interior with subtle tropical reflections. It tightly specifies identity preservation, facial features, makeup, hair, outfit, accessories, background elements, lighting direction, color palette, textures, and overall mood to produce a serene, intimate, high-resolution skincare-style portrait without unrealistic reshaping or over-smoothing.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `blushed-summer-portrait`).

Command form:

```bash
betterprompt generate blushed-summer-portrait \
  [--image-input-url <url>] \
