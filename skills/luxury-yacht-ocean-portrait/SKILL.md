---
name: luxury-yacht-ocean-portrait
description: This prompt directs an image-generation system to produce a high-end fashion editorial portrait of a confident woman in a sculpted black gown leaning over the rail of a speeding modern luxury yacht, shot from an extreme overhead, intentionally rotated angle so she appears suspended above vivid turquoise ocean and explosive wake; it specifies composition, pose, expression, lighting, textures, color palette, and realism targets while listing exclusions to avoid common failures, resulting in a cinematic, Riviera-glamour luxury campaign–style image with sharp detail and dynamic motion.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `luxury-yacht-ocean-portrait`).

Command form:

```bash
betterprompt generate luxury-yacht-ocean-portrait \
  [--image-input-url <url>] \
