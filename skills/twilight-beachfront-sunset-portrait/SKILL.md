---
name: twilight-beachfront-sunset-portrait
description: This prompt instructs an image-generation system to create a high-end, magazine-quality twilight beach editorial portrait of a single young woman, specifying precise pose, expression, styling, jewelry, outfit, environment, color palette, lighting setup, camera composition, and filmic texture. The expected outcome is an ultra-photorealistic, cinematic luxury fashion image with sharp facial detail and shallow depth of field against a softly blurred, vividly colored sunset shoreline, while explicitly avoiding common visual artifacts and unwanted elements.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `twilight-beachfront-sunset-portrait`).

Command form:

```bash
betterprompt generate twilight-beachfront-sunset-portrait \
  [--image-input-url <url>] \
