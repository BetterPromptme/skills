...
Use the frontmatter's `name` as the positional argument (for this skill, use `the-glam-secretary`).

Command form:

```bash
betterprompt generate the-glam-secretary \
  [--image-input-url <url>] \
