...
skillVersionId: 0199b87e-56b4-780e-946d-f0f977fc81d9
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0199b87e-56b4-780e-946d-f0f977fc81d9`).

Command form:

```bash
betterprompt generate 0199b87e-56b4-780e-946d-f0f977fc81d9 \
  [--input <key>=<value>] \
  [--image-input-url <url>] \
