...
skillVersionId: 0197776e-4280-7691-ad02-deca9bbc78bd
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0197776e-4280-7691-ad02-deca9bbc78bd`).

Command form:

```bash
betterprompt generate 0197776e-4280-7691-ad02-deca9bbc78bd \
  [--input <key>=<value>] \
  [--model <model>] \
