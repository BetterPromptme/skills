...
skillVersionId: 019bea1f-e262-7383-bbb2-b8c569554243
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019bea1f-e262-7383-bbb2-b8c569554243`).

Command form:

```bash
betterprompt generate 019bea1f-e262-7383-bbb2-b8c569554243 \
  [--image-input-url <url>] \
