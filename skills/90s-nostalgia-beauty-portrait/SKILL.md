...
Use the frontmatter's `name` as the positional argument (for this skill, use `90s-nostalgia-beauty-portrait`).

Command form:

```bash
betterprompt generate 90s-nostalgia-beauty-portrait \
  [--image-input-url <url>] \
