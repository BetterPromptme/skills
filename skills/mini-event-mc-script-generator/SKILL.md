...
skillVersionId: 0198c6c3-2b66-7fbc-bb30-0e9384f8f35a
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `0198c6c3-2b66-7fbc-bb30-0e9384f8f35a`).

Command form:

```bash
betterprompt generate 0198c6c3-2b66-7fbc-bb30-0e9384f8f35a \
  [--input <key>=<value>] \
  [--model <model>] \
