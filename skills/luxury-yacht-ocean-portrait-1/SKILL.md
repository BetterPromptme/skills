---
name: luxury-yacht-ocean-portrait-1
description: This prompt instructs an image-generation model to create a high-end, cinematic fashion editorial portrait set on a vintage wooden speedboat cruising Lake Como, specifying camera framing, subject pose and styling, luxury accessories, boat materials, water and villa-filled scenery, lighting, color palette, textures, and overall “old-money” travel mood, while also listing elements to avoid, resulting in an ultra-realistic, magazine-quality vertical campaign image that feels exclusive and timeless.
...
Use the frontmatter's `name` as the positional argument (for this skill, use `luxury-yacht-ocean-portrait-1`).

Command form:

```bash
betterprompt generate luxury-yacht-ocean-portrait-1 \
  [--image-input-url <url>] \
