...
| `Academic_level` | Required |  | (none) |
| `Study_environment` | Required |  | (none) |
| `Learning_preferences` | Required |  | (none) |
| `Time_available_per_day` | Required |  | (none) |
...
betterprompt generate personalized-study-game-plan \
  ...
  --input Learning_preferences=<value> \
  --input Time_available_per_day=<value> \
  --model gpt-4.1-mini \
  --options '{}'
```