...
Use the frontmatter's `name` as the positional argument (for this skill, use `personalized-social-caption-generator`).

Command form:

```bash
betterprompt generate personalized-social-caption-generator \
  [--input <key>=<value>] \
  [--model <model>] \
