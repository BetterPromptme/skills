...
Use the frontmatter's `name` as the positional argument (for this skill, use `line-lives-minimal-sketch-figures-in-real-spaces`).

Command form:

```bash
betterprompt generate line-lives-minimal-sketch-figures-in-real-spaces \
  [--image-input-url <url>] \
