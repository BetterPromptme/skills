...
skillVersionId: 019b4ea8-f5e7-7585-aa3c-ae96631a2a70
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019b4ea8-f5e7-7585-aa3c-ae96631a2a70`).

Command form:

```bash
betterprompt generate 019b4ea8-f5e7-7585-aa3c-ae96631a2a70 \
  [--image-input-url <url>] \
