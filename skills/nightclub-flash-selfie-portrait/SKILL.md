...
Use the frontmatter's `name` as the positional argument (for this skill, use `nightclub-flash-selfie-portrait`).

Command form:

```bash
betterprompt generate nightclub-flash-selfie-portrait \
  [--image-input-url <url>] \
