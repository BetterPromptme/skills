...
Use the frontmatter's `name` as the positional argument (for this skill, use `retro-modern-muse`).

Command form:

```bash
betterprompt generate retro-modern-muse \
  [--image-input-url <url>] \
