...
Use the frontmatter's `name` as the positional argument (for this skill, use `triple-pose-lookbook`).

Command form:

```bash
betterprompt generate triple-pose-lookbook \
  [--image-input-url <url>] \
