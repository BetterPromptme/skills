...
skillVersionId: 019a0af2-6a02-731d-abac-89254097053a
---
...
Use the frontmatter's `skillVersionId` as the positional argument (for this skill version, use `019a0af2-6a02-731d-abac-89254097053a`).

Command form:

```bash
betterprompt generate 019a0af2-6a02-731d-abac-89254097053a \
  [--image-input-url <url>] \
