...
Use the frontmatter's `name` as the positional argument (for this skill, use `surveillance-style-cctv-portrait`).

Command form:

```bash
betterprompt generate surveillance-style-cctv-portrait \
  [--image-input-url <url>] \
